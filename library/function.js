...
async function loading(m, emoji = '🕖', delay = 3000) {
  try {
...
async function done(m, emoji = '✅') {
    await sock.sendMessage(m.chat, { react: { text: emoji, key: m.key } })
}

async function gagal(m, emoji = '❌') {
    await sock.sendMessage(m.chat, { react: { text: emoji, key: m.key } })
}

module.exports = { unixTimestampSeconds, generateMessageTag, processTime, webApi, getRandom, getBuffer, fetchJson, runtime, clockString, sleep, isUrl, getTime, formatDate, tanggal, formatp, jsonformat, reSize, toHD, logic, generateProfilePicture, bytesToSize, checkBandwidth, getSizeMedia, parseMention, getGroupAdmins, readFileTxt, readFileJson, getHashedPassword, generateAuthToken, cekMenfes, generateToken, batasiTeks, randomText, isEmoji, getTypeUrlMedia, pickRandom, getAllHTML, toIDR, capital, tiktokDl, loading, react, done, gagal};
